...
class CudaRendererGpu:
    ...
    def __init__(self,
        ...
        self.enable_depth_peel_attr     = enable_depth_peel_attr
        ...
        self.cudaRendererOperator = customOperators.cuda_renderer_gpu(  faces                   = self.faces_attr,
                                                                        ...
                                                                        enable_depth_peel  = self.enable_depth_peel_attr,
    ...
    def getRenderSecondBufferTF(self):
        return self.cudaRendererOperator[5]

    ########################################################################################################################

    #def getRenderThirdBufferTF(self):
    #    return self.cudaRendererOperator[6]

    ########################################################################################################################

    #def getRenderFourthBufferTF(self):
    #    return self.cudaRendererOperator[7]

    ########################################################################################################################

    #def getRenderFifthBufferTF(self):
    #    return self.cudaRendererOperator[8]

    ########################################################################################################################

    #def getRenderSixthBufferTF(self):
    #    return self.cudaRendererOperator[9]

    ########################################################################################################################

    #def getRenderSeventhBufferTF(self):
    #    return self.cudaRendererOperator[10]

    ########################################################################################################################

    #def getRenderEighthBufferTF(self):
    #    return self.cudaRendererOperator[11]

    ########################################################################################################################

    #def getRenderNinthBufferTF(self):
    #    return self.cudaRendererOperator[12]

    ########################################################################################################################

    #def getRenderTenthBufferTF(self):
    #    return self.cudaRendererOperator[13]
