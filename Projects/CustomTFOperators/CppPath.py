...
def getCustomOperatorPath():
    ...
    if 'recon' in hostname or 'd2volta' in hostname:
        ...
        CUSTOM_OPERATORS_PATH = "Z:/RTMPC/work/MultiViewSupervisionNRTracking/Code/CustomTensorFlowCPPOperators/binaries/Win64/Release/CustomTensorFlowOperators.dll"
...
def getRendererPath():
    ...
    if 'recon' in hostname or 'd2volta' in hostname:
        ...
        RENDERER_PATH = "Z:/RTMPC/work/MultiViewSupervisionNRTracking/Code/CudaRenderer/cpp/binaries/Win64/Release/CudaRenderer.dll"
    elif 'gpu20' in hostname or 'gpu-a16' in hostname or 'gpu-a30' in hostname or 'gpu-a40' in hostname:
