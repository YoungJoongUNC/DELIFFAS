...
class CUDABasedRasterization
{
	...
	public:
		...
		inline float*							get_D_renderSecondBuffer()					{ return input.d_renderSecondBuffer; };
        ...
        inline void							set_D_renderSecondBuffer(float* newRenderBuffer)				{ input.d_renderSecondBuffer = newRenderBuffer; };
