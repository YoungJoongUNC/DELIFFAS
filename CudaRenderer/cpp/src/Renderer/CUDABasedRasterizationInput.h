...
struct CUDABasedRasterizationInput
{
	...
	bool				enableDepthPeel;						//flag whether the to enable depth peeling (only second depth)		//INIT IN CONSTRUCTOR
	...
	int*                d_depthSecondBuffer;                    //second smalled depth value per pixel per view
	...
	float*				d_renderSecondBuffer;					//buffer for the final image
